...
var gMeme = {
    ...
    selectedLineIdx: 0,
    lines: [
        { txt: '', size: 30, align: 'center', stroke: 'black', font: 'impact', color: 'white', x: 200, y: 100 }
    ],
...
function addLine() {
    ...
    else if (gMeme.lines.length === 1) line = createExistsLine(300)
    else line = createExistsLine(200)
...
function createSticker(stickerId) {
    ...
    gMeme.stickers[gMeme.selectedStickerIdx].url = findSticker.url
    gMeme.stickers[gMeme.selectedStickerIdx].size = 40
    gMeme.stickers[gMeme.selectedStickerIdx].x = 200
    gMeme.stickers[gMeme.selectedStickerIdx].y = 200
